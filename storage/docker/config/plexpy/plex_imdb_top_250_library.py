...
### Plex server details ###
PLEX_URL = 'https://yoursite'
PLEX_TOKEN = 'yourtoken'

### Existing movie library details ###
MOVIE_LIBRARY_NAME = 'Movies'
MOVIE_LIBRARY_FOLDERS = ['/storage/data/movies/']  # List of movie folders in library

### New IMDB Top 250 library details ###
IMDB_CHART_URL = 'http://www.imdb.com/chart/top'
IMDB_LIBRARY_NAME = 'IMDB Top 250'
IMDB_FOLDER = '/storage/data/imdbtop250/'  # New folder to symlink existing movies to
...
def run_imdb_top_250():
    ...
    matching_movies = []
    for m in all_movies:
        if m.guid != PlexServer and 'imdb://' in m.guid:
            imdb_id = m.guid.split('imdb://')[1].split('?')[0]
        elif m.guid != PlexServer and 'themoviedb://' in m.guid:
